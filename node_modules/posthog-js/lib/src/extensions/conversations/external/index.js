...
var ConversationsManager = /** @class */ (function () {
    function ConversationsManager(config, _posthog) {
        ...
        this._handleSendMessage = function (message) { return __awaiter(_this, void 0, void 0, function () {
            var userTraits, isNewTicket, response, error_1;
            var _this = this;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        isNewTicket = !this._currentTicketId;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._apiSendMessage(message, this._currentTicketId || undefined, userTraits)
    ...
    ConversationsManager.prototype._apiSendMessage = function (message, ticketId, userTraits) {
        var _this = this;
    ...
    ConversationsManager.prototype._apiGetMessages = function (ticketId, after) {
        var _this = this;
        var token = this._config.token;
        // eslint-disable-next-line compat/compat
        return new Promise(function (resolve, reject) {
            ...
            _this._posthog._send_request({
                url: _this._posthog.requestRouter.endpointFor('api', "/api/conversations/v1/widget/messages/".concat(ticketId, "?").concat((0, request_utils_1.formDataToQuery)(queryParams))),
                method: 'GET',
                headers: {
                    'X-Conversations-Token': token,
                },
    ...
    ConversationsManager.prototype._apiMarkAsRead = function (ticketId) {
        var _this = this;
        var token = this._config.token;
        // eslint-disable-next-line compat/compat
        return new Promise(function (resolve, reject) {
            logger.info('Marking messages as read', { ticketId: ticketId });
            _this._posthog._send_request({
                url: _this._posthog.requestRouter.endpointFor('api', "/api/conversations/v1/widget/messages/".concat(ticketId, "/read")),
                method: 'POST',
                data: {
                    widget_session_id: _this._widgetSessionId,
                },
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._apiMarkAsRead(this._currentTicketId)];
                    case 2:
                        response = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._apiGetMessages(this._currentTicketId, this._lastMessageTimestamp || undefined)
     ...
     */
    ConversationsManager.prototype.enable = function () {
        var _a;
        (_a = this._widgetRef) === null || _a === void 0 ? void 0 : _a.show();
    };
    /**
     * Disable/hide the widget completely (button and chat panel)
     */
    ConversationsManager.prototype.disable = function () {
        var _a;
        (_a = this._widgetRef) === null || _a === void 0 ? void 0 : _a.hide();
    };
    /**
     * Send a message programmatically (internal use)
     */
    ConversationsManager.prototype.sendMessage = function (message) {
